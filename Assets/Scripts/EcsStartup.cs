    ...
    sealed partial class EcsStartup : MonoBehaviour {
        ...
        void Start () {
            ...
            _systems
                ...
                .Add (new BoardInitSystem()) // спавним ентити, спавним префабы (св€занные с энтити)
                ...
                .Add (new MoveSystem()) // мен€ет местами
                .Add (new CheckMatchSystem())
                .Add (new DestroySystem()) // унитожает св€занный с энтити геймобжект
                .Add (new SpawnSystem ()) // спавнит новый и св€зывает с энтитей
                //.Add (new CheckMoveAvailableSystem()) // ѕроверка на наличие ходов
